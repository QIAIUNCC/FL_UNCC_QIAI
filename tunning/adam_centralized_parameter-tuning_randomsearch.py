...
for params in param_list:
    ...
    train_dataset = torch.utils.data.ConcatDataset([kermany_dataset_train, srinivasan_dataset_train, oct500_dataset_train])
...
print(optimizer, "Centralized", "random search")
