...
from hyperparameters import get_centralized_AdamW_ViT_parameters
...
if __name__ == "__main__":
    ...
    adam_config = get_centralized_AdamW_ViT_parameters()
    ...
    for i in range(1, 11):
        ...
        # for i in range(1, 11):
        #     simulation_main(net=net, client_fn=client_fn)
